...
<!--Indicators-->
    <ol class="carousel-indicators">
        ...
        @foreach($home as $data)
            <li data-target="#carousel-example-2" data-slide-to="{{ $data->id }}"></li>
        @endforeach
    </ol>
  <!--/.Indicators-->
  <!--Slides-->
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
            <!--Mask color-->
            <div class="view">
                <img class="d-block w-100 h-100" src="{{ asset('img/slide1.jpg') }}" alt="Second slide">
        ...
        @foreach($home as $data)
            <div class="carousel-item">
                ...
                <div class="view">
                    <img class="d-block w-100 h-100" src="{{ asset('img/slider/'.$data->name_of_image) }}"  alt="{{$data->id}} slide">
                    <div class="mask rgba-black-light"></div>
                </div>
            </div>
        @endforeach
